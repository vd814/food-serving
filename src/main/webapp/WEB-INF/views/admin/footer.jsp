...
<footer class="footer">
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-6">2020 &copy; FOOD SERVING</div>
		</div>
	</div>
</footer>
<!-- end Footer -->
...
function initiliztionSwitch(){
	var elems = Array.prototype.slice.call(document.querySelectorAll('.js-switch'));
	elems.forEach(function(html) {
		var switchery = new Switchery(html,{ size: 'small',color:successColor,secondaryColor: dangerColor, jackColor: 'white', jackSecondaryColor: 'white' });
	});
}
