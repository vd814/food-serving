...
<div class="content-page">
	...
	<div class="content">
		...
		<!--edit Complain Modal Start-->
		<a href="#editComplainModal" id="forEditComplainModal" class="hide"
			data-animation="fadein" data-plugin="custommodal"
			data-overlaycolor="#38414a"> </a>
		<div id="editComplainModal" class="modal-demo">
			<button type="button" class="close"
				onclick="Custombox.modal.close();">
				<span>&times;</span><span class="sr-only">Close</span>
			</button>
			<h4 class="custom-modal-title">Edit Complain Detail</h4>
			<div class="custom-modal-text text-left">
				<form action="editComplain" method="post" id="editComplainForm">
						...
						<div class="col-md-12">
							<div class="form-group">
								<label for="groupName" class="control-label">Complain</label> <input
									type="text" class="form-control" id="editComplain" name="editComplain"
					...
					<div class="text-center">
						<button type="submit"
							class="btn btn-success waves-effect waves-light "><i class="fa fa-edit"></i> Edit Complain</button>
						<button type="button"
		...
		<div id="addReplayModal" class="modal-demo">
			...
			<div class="custom-modal-text text-left">
				<form action="addReplayByAdmin" method="post" id="addReplayByAdmin">
					<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
		...
		<div id="editReplayModal" class="modal-demo">
			...
			<div class="custom-modal-text text-left">
				<form action="editReplayByAdmin" method="post" id="editReplayByAdmin">
					<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}" />
					<input type="hidden" name="editComplainIdforReplay" id="editComplainIdforReplay" />
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								<label for="groupName" class="control-label">Replay</label> <input
...
<script src="<%=Constant.BASEURL%>assets/js/custom/admin/complainList.js"></script>