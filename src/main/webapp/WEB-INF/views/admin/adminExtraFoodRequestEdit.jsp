...
<div class="content-page">
	...
	<form action="<%=Constant.AFTER_LOGIN_ADMIN_BASEURL %>editExtraFoodRequest" method="post" id="createRequest">
...
<script src="<%=Constant.BASEURL%>assets/js/custom/admin/adminExtraFoodRequestEdit.js"></script>