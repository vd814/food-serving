...
<div class="content-page">
	...
	<form action="<%=Constant.AFTER_LOGIN_BASEURL %>editNeedFoodRequest" method="post" id="editRequest">
...
<script src="<%=Constant.BASEURL%>assets/js/custom/common/userNeedFoodRequestEdit.js"></script>