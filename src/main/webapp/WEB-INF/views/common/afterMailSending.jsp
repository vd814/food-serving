...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title><%=request.getAttribute("mailPageTitle") %></title>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card bg-pattern">
                            ...
                            <div class="card-body p-4" style="box-shadow: 0px 0px 1px 1px #b9bcbf;">
                                ...
                                <div class="mt-3 text-center">
                                    ...
                                    <h3><%=request.getAttribute("mailTitle") %></h3>
                                    <p class="text-muted font-14 mt-2"> <%=request.getAttribute("mailMsg") %></p>

                                    <a href="signIn" class="btn btn-block btn-pink waves-effect waves-light mt-3">Back to Login</a>
                                </div>
