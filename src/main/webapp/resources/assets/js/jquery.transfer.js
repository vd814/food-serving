    ...
    function transfer(settings) {
        ...
        $(transferId).find(tabItemName).on("click", function () {
            ...
            if (!$(this).is(".tab-active")) {
                ...
                // 清空右侧数量
                $(transferId).find(selectedTotalNum).text("0 Granted Permission");
                // 未选中项
                ...
                for (var i = 0; i < $(transferId).find(checkboxItem).length; i++) {
                    if ($(transferId).find(checkboxItem).eq(i).is(':checked')) {
                        ...
                        listHtmlStr = listHtmlStr + '<li class="transfer-double-selected-list-li  transfer-double-selected-list-li-' + currentTimeStr + ' .clearfix">' +
                            ...
                            '<label class="checkbox-selected-name-' + currentTimeStr + ' right-item" for="selectedCheckbox_' + idIndex + '_' + currentTimeStr + '" data-id="'+value+'">' + val + '</label>' +
                            '</div>' +
                            '</li>';
                        selectedItemNum = selectedItemNum + 1;
                    }
    ...
    function generateLeftList(currentTimeStr, data, itemName, valueName) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            listHtmlStr = listHtmlStr +
                '<li class="transfer-double-list-li transfer-double-list-li-' + currentTimeStr + '" data-roleActionId="'+data[i].roleActionId+'">' +
                '<div class="checkbox-group">' +
                ...
                '<label class="checkbox-name-' + currentTimeStr + ' left-item" for="itemCheckbox_' + i + '_' + currentTimeStr + '" data-id="'+data[i].actionId+'">' + data[i][itemName] + '</label>' +
                '</div>' +
                '</li>'
        }
        return listHtmlStr;
...
//    }
    ...
    function generateTransfer(inputId, currentTimeStr) {
        var htmlStr =
            ...
            + '<div class="tab-item-name tab-item-name-' + currentTimeStr + ' tab-active">Permission</div>'
            + '</div>'
            ...
            + '<div class="btn-select-arrow add-item-custome" id="add_selected_' + currentTimeStr + '"><i class="iconfont icon-forward"></i></div>'
            + '<div class="btn-select-arrow delete-item-custome" id="delete_selected_' + currentTimeStr + '"><i class="iconfont icon-back"></i></div>'
            + '</div>'
            + '<div class="transfer-double-content-right">'
            + '<div class="transfer-double-content-param">'
            + '<div class="param-item">Granted Permission</div>'
            + '</div>'
            ...
            + '</div>'
            + '<div class="transfer-double-list-footer">'
            + '<label class="selected_total_num_' + currentTimeStr + '">0 Granted Permission</label>'
            + '</div>'
            + '</div>'
            + '</div>'
            + '</div>'
